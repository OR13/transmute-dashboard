...
export class GDAXExchangeController {
    ...
    constructor(
        ...
        $log.debug('GDAXExchangeController... bro')
        ...
        this.marketData = localStorageService.get('SampleData')
        ...
        if (!this.marketData) {
            ...
            socket.on('news', (data) => {
                ...
                if (this.marketData.length > 300) {
                    localStorageService.set('SampleData', this.marketData)
                }

            });
        } else {
            $log.debug('marketData has been loaded...', this.marketData);
        }
        ...
        var svg = d3.select(".exchange-feed").append("svg")
        ...
        d3.csv("/assets/csv/feed.csv", function (error, csv) {
